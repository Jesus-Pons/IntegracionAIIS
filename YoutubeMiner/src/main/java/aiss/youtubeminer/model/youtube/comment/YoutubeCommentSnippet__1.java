...
public class YoutubeCommentSnippet__1 {
    ...
    private YoutubeAuthorChannelId youtubeAuthorChannelId;
    ...
    @JsonProperty("authorChannelId")
    public YoutubeAuthorChannelId getAuthorChannelId() {
        return youtubeAuthorChannelId;
    }

    @JsonProperty("authorChannelId")
    public void setAuthorChannelId(YoutubeAuthorChannelId youtubeAuthorChannelId) {
        this.youtubeAuthorChannelId = youtubeAuthorChannelId;
    }
    ...
    public String toString() {
        ...
        sb.append('=');
        sb.append(((this.youtubeAuthorChannelId == null)?"<null>":this.youtubeAuthorChannelId));
        sb.append(',');
