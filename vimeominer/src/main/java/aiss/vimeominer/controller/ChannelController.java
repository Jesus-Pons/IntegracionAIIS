...
public class ChannelController {
    ...
    @GetMapping("/{id}")
    public Channel get(@PathVariable(value="id") String channelId, @RequestParam(defaultValue = "10") int maxVideos,@RequestParam(defaultValue = "10") int maxComments){
    ...
    @PostMapping("/{id}")
    public Channel post(@PathVariable(value="id") String channelId, @RequestParam(defaultValue = "10") int maxVideos,@RequestParam(defaultValue = "10") int maxComments){
