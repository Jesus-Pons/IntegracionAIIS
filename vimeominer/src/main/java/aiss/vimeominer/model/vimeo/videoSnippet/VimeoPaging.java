...
package aiss.vimeominer.model.vimeo.videoSnippet;
...
public class VimeoPaging {
    ...
    public String toString() {
        ...
        sb.append(VimeoPaging.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("next");
        sb.append('=');
